...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/Argoverse.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/yolo_best_continue3/weights/best.pt', help='model path(s)')
